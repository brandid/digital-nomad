...
//     proxy: "http://digital-nomad.dev" // use http://_s.com:3000 to use BrowserSync
//   });
//
...
gulp.task('pot', function() {
  return gulp.src(['./**/*.php'])
    .pipe(wpPot({
      domain: 'digital-nomad',
      package: 'Digital Nomad'
    }))
    .pipe(gulp.dest('languages/digital-nomad.pot'));
});
