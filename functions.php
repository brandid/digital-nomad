 ...
 * Digital Nomad Theme
 *
 * This file adds functions to the Digital Nomad theme.
 *
...
if ( defined( 'DIGITAL_NOMAD_DEBUG' ) && DIGITAL_NOMAD_DEBUG  ) {
...
add_action( 'after_setup_theme','digital_nomad_localization_setup' );
/**
 * Loads text Domain
 *
 * @since  1.0.0
 */
function digital_nomad_localization_setup() {
	load_child_theme_textdomain( 'digital-nomad', apply_filters( 'child_theme_textdomain', CHILD_THEME_DIR . '/languages', 'digital-nomad' ) );
}
